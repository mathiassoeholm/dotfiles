...
> **CRITICAL:** You MUST use the Agent tool with `subagent_type: "general"` to execute GitHub CLI commands. NEVER run `gh` commands directly in your bash session.

Example Agent invocation:
```
Agent(subagent_type="general", prompt="Use gh CLI to list branches: gh branch list --json name,updatedAt")
```
